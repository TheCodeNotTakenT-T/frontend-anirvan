...
// Update the first section tag and the badge container
...
const LandingView: React.FC<LandingViewProps> = ({ setView }) => {
  return (
    <div className="space-y-16 pb-20">
      {/* 1. HERO SECTION 
          Changed pt-0 to pt-20 to move the text/buttons (encircled area) down.
          Added overflow-visible to allow the background to bleed upwards.
      */}
      <section className="relative pt-20 pb-32 px-4 overflow-visible min-h-[700px] flex flex-col items-center">
        
        {/* LIQUID ETHER BACKGROUND
            Changed top-0 to -top-[76px] to pull the effect to the very top of the page.
            Increased height to h-[calc(100%+76px)] to cover the extra space.
        */}
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-anirvan-muted max-w-2xl mx-auto mb-12">
            Connect small landowners to the $2 Billion carbon market. <br />
            Automated verification via satellite data, secured by blockchain.
          </p>
      ...
      {/* 3. CENTERED DYNAMICS SECTION (CardSwap Integration) */}
      <section className="max-w-7xl mx-auto px-4 py-24 overflow-visible">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight tracking-tight">
              Scaling Nature with <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-green-500">Algorithmic Trust.</span>
            </h2>
            <p className="text-lg text-anirvan-muted max-w-md leading-relaxed">
          ...
          <div className="relative flex items-center justify-center min-h-[500px]">
            {/* Aspect Ratio Container for CardSwap */}
